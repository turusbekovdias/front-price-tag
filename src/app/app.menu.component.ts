        ...
        this.model = [
            {
                ...
                items:[
                    ...
                    {label: 'Company', icon: 'pi pi-fx pi-tablet', routerLink: ['/company']},
                    {label: 'Store', icon: 'pi pi-fx pi-home', routerLink: ['/store']},
                    {label: 'Base Station', icon: 'pi pi-fx pi-mobile', routerLink: ['/basestation']},
                    {label: 'Price Tag', icon: 'pi pi-fw pi-tablet', routerLink: ['/pricetag']},
                    {label: 'Product', icon: 'pi pi-fw pi-list', routerLink: ['/product']}
                ]
            }
            // {
            //     label: 'UI Components',
